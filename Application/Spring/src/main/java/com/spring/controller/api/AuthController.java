...
import com.spring.playload.request.LoginRequest;
import com.spring.playload.request.SignupRequest;
import com.spring.playload.response.MessageResponse;
import com.spring.playload.response.UserInfoResponse;
    ...
    if (strRoles == null) {
      ...
      strRoles.forEach(role -> {
        ...
        case "mod" :
          ...
          break;
        default:
          Role userRole = roleRepository.findByName(RoleEnum.USER).orElseThrow(() -> new RuntimeException("Error: User is not found."));
          roles.add(userRole);
        }
      });
    }
